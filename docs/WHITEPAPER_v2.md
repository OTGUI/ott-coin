...
| # | 이름 | 스타일 | 소재 | 풀 |
|---|------|--------|------|-----|
| 1 | 🥇 **Gold** | 엠보싱 금화 스타일 | 불굴의 의지 | **Phase 1 (Pump.fun) 전용** |
...
> **🥇 Gold Mythic — Phase 1 독점:** Pump.fun에서 $OTT를 보유한 홀더에게만 에어드롭될 수 있는 유일한 Mythic입니다. **단 1개만** 존재하며, 극한의 확률로 당첨됩니다. Phase 1 초기 참여자만이 도전할 수 있는 궁극의 보상입니다.
