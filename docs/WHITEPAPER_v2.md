...
│                                                   │
│  🔄 스왑: Pump.fun OTT → Raydium OTT (1:1)        │
...
> **📢 Phase 1 참여자 혜택:** Pump.fun에서 구매한 $OTT는 Phase 2 Raydium 풀의 $OTT로 **1:1 무료 스왑**이 가능합니다. 초기 참여자일수록 낮은 가격에 진입하여 더 많은 토큰을 확보할 수 있습니다.
...
| 항목 | 비율 | 수량 | 용도 | 락업 |
|------|------|------|------|------|
| **마이그레이션 풀** | 50% | 1,215,000,000,000 | Phase 1 홀더 1:1 스왑 | 스왑 요청 시 해제 |
...
**스왑 규칙:**
- ✅ Pump.fun OTT → Raydium OTT: **1:1 무료 스왑** (네트워크 수수료만 부담)
